...
- Added QUIC short-header constriction for known DCIDs.
- Added clean `Ctrl+C` shutdown.
- Added live capture summary and Npcap/libpcap statistics.
- Added standalone tests and golden fixtures.
